  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5">
      <div className="max-w-xl rounded-[32px] border border-[var(--border)] bg-[var(--panel)] p-8 text-center shadow-[var(--shadow)]">
        <p className="text-xs uppercase tracking-[0.24em] text-[var(--muted)]">Prediction Signal</p>
        <h1 className="mt-4 text-4xl font-semibold">Market not found</h1>
        <p className="mt-4 text-lg leading-8 text-[var(--muted)]">
          The requested market record does not exist in the current database snapshot.
        </p>
        <Link
          href="/"
